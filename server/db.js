...
export async function initDb() {
  await pool.query(`
    ...
    ALTER TABLE editais ADD COLUMN IF NOT EXISTS regime TEXT NOT NULL DEFAULT 'CLT';
    ALTER TABLE editais ADD COLUMN IF NOT EXISTS todos_cargos_basicos BOOLEAN NOT NULL DEFAULT TRUE;
